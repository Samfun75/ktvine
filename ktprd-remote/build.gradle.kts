...
kotlin {
    ...
    androidLibrary {
        namespace = "io.github.samfun75.ktprd.remote"
...
mavenPublishing {
    ...
    coordinates(group.toString(), "ktprd-remote", version.toString())

    pom {
        name = "ktprd-remote"
        description = "Ktor-based client for a pyplayready-compatible remote PlayReady CDM server"
        inceptionYear = "2025"
